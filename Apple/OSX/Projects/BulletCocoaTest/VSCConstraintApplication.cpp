...
void VSCConstraintApplication::swapBuffers()
{
	glutSwapBuffers();
}


void VSCConstraintApplication::setupEmptyDynamicsWorld()
{
...
void VSCConstraintApplication::initPhysics()
{
	setTexturing(true);
	setShadows(true);
...
void	VSCConstraintApplication::exitPhysics()
{
...
/*
void VSCConstraintApplication::clientMoveAndDisplay()
{
...
void VSCConstraintApplication::clientResetScene()
{
	exitPhysics();
	initPhysics();
}	

void VSCConstraintApplication::display(void) {
	...
	VSCRootApplication::display();
	
}


void VSCConstraintApplication::simulate()
{
...
void VSCConstraintApplication::keyboardCallback(unsigned char key, int x, int y)
{
	(void)x;
	(void)y;
	switch (key) 
