...
std::string VSC::OB::OgreEntityDescription(Ogre::Entity* entity)
{
    ...
    GetOgreMeshInformation(meshPtr.get(), vertex_count, vertices, index_count, indices, position, orient, scale);
    
    s << "Ogre::Entity " << vertex_count << " vertices: \n";
...
void VSC::OB::GetOgreMeshInformation(const Ogre::Mesh* const mesh,
                                     size_t &vertex_count,
                                     Ogre::Vector3* &vertices,
                                     size_t &index_count,
                                     unsigned long* &indices,
